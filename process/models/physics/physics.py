...
class Physics(Model):
    ...
    def run(self):
        ...
        self.data.physics.pden_plasma_core_rad_tau_energy_mw = (
            radpwrdata.pden_plasma_core_rad_tau_energy_mw
        )
        ...
        # time scaling
        reduced_pden = self.data.physics.pden_plasma_core_rad_tau_energy_mw
